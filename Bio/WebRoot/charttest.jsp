...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.html">Biosearch </a>
      <div class="nav-collapse">
        <ul class="nav pull-right">
          ...
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user"></i> Biosearch.com <b class="caret"></b></a>
            <ul class="dropdown-menu">
        ...
        <form class="navbar-search pull-right">
          <input type="text" class="search-query" placeholder="Search Keyword">
        </form>
      </div>
      <!--/.nav-collapse --> 
    </div>
...
<div class="footer">
  <div class="footer-inner">
    <div class="container">
      <div class="row">
        <div class="span12"> &copy; 2015 <a href="http://www.biosearch.com/">HIT Biosearch Lab</a>. </div>
        <!-- /span12 --> 
      </div>
      <!-- /row --> 
    </div>
