...
public class FindCorrespondingHierarchy {
	...
	public FindCorrespondingHierarchy() {
	}

	public FindCorrespondingHierarchy(String path) {
		this.basepath = path;
...
//		this.N = entleaf.size() + 1;
	...
	public HierarcyBackForFindResults CircleFindCluster(int begin, int end,
			ArrayList<String> mkw, String root,
...
//		System.out.println("hereee: "+root+" "+begin+ " "+end+" "+mkw.size()+" "+rootAndpath.size());   ///// +begin+"　"+end+" "+mkw		
//		System.out.println("end: "+end); //// 100
		HierarcyBackForFindResults res = BinarySearch(begin, end, mkw, root,entcutoff);
//		System.out.println("hereee: "+root+" "+begin+ " "+end+" "+mkw.size()+" "+rootAndpath.size());   ///// +begin+"　"+end+" "+mkw		

//		System.out.println("Hierarchy:" + res.getIndex());		
//		System.out.println("Root:" + res.getRoot());
//		System.out.println("This root hierarchy cluster:"
//				+ res.getIndexContent());
...
//			System.out.println(s+"-------"+d);
	...
	public static void main(String[] args) {
		...
		// H ms2 = H.loadMapData(
		// new File(fr2path + "199" + ".dat"), true, 1);
		// HashMap<String, ArrayList<String>> entcutoff1 = ms2.ent;
		// HierarcyBackForFindResults res = fch.OneOptimalFindHierarchy(1, N,
		// mkw, "199",entcutoff1);
		//
		// System.out.println(res.getIndex());
		// System.out.println(res.getIndexContent());
		// System.out.println(res.getClusterContainKey());
		// System.out.println(fch.ApplayDreyfus(res));
		...
		// ArrayList<String> values = (ArrayList<String>) map.get(key);
		// if(values.size() >=3){
		// res = fch.BinarySearch(bindex, N,values, (String) key);
		// System.out.println(res.getIndex());
		// System.out.println(res.getIndexContent());
		// System.out.println(res.getClusterContainKey());
		// }
		...
		// fch.PartitionLeafNodesToCorrespondingCluster(res.getIndexContent());
		// 生成文件

//		System.out.println("------------------");
//		ArrayList<String> allName = fch.getAllName(fch.fr2path);
//		System.out.println(allName);
//		for (int root = 9973; root > 4987; root--) {
//			if (allName.contains(root + "")) {
//				HierarchyMapSerializable ms2 = HierarchyMapSerializable
//						.loadMapData(new File(fch.fr2path + root + ".dat"),
//								true, 1);
//				HashMap<String, ArrayList<String>> entcutoff = ms2.ent;
//				HashMap<String, ArrayList<String>> map = entcutoff;
//				Set<String> set = map.keySet();
//				Iterator<String> it = set.iterator();
//				while (it.hasNext()) {
//					Object key = it.next();
//					ArrayList<String> values = (ArrayList<String>) map.get(key);
//					fch.PartitionLeafNodesToCorrespondingCluster(path
//							+ "Edges.csv", (String) key, values, root + "");
//				}
//			}
//		}
		...
		// if(allName.contains(root+"")){
		// HierarchyMapSerializable ms2 = HierarchyMapSerializable
		// .loadMapData(new File(fch.fr2path + root + ".dat"), true, 1);
		// HashMap<String, ArrayList<String>> entcutoff = ms2.ent;
		// HashMap<String, ArrayList<String>> map = entcutoff;
		// Set<String> set = map.keySet();
		// Iterator<String> it = set.iterator();
